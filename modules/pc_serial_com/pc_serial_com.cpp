...
static void pcSerialComCommandUpdate( char receivedChar )
{
    switch (receivedChar) {
        ...
        case 'l': case 'L': commandShowLDR();break;
...
static void availableCommands()
{
    ...
    pcSerialComStringWrite( "Press 'l' or 'L' to show the LDR raw and filtered readings\r\n" );
    pcSerialComStringWrite( "\r\n" );
}
...
static void commandShowLDR(){
    char str[100] = "";
    sprintf ( str, "LDR raw reading: %.4f, LDR filtered reading: %.4f \xB0 \r\n", LDR_Raw_Output(),LDR_Filtered_Output());
